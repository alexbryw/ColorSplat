...
var StartMenu = (function () {
    function StartMenu(x, y, playerFactory) {
        ...
        this.bgColor = '#1B1E1A';
        this.playerSelectButton = new _btn.RadioButton(windowWidth / 2, windowHeight / 3, windowWidth / 2, 100, this.bgColor, this.isPlayerPressed, [1, 2, 3, 4], this.noOfPlayers);
